...
local function test_navigation_runtime_helper()
  ...
  local handled = navigation_runtime.on_message(self, navigation_messages.MARK_DIRTY, {})
  check(handled == true, "navigation runtime: on_message should delegate navigation transport messages")
  check(navigation.is_dirty() == true, "navigation runtime: delegated mark_dirty should affect app-wide navigation state")
